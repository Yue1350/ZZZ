...
> **젠레스 존 제로(Zenless Zone Zero)** 에이전트들의 최신 세팅 정보, 디스크 옵션, W-엔진 추천을 구글 시트 기반으로 실시간 제공하는 디스코드 봇입니다.
...
* **🔊 음성 채널 지원 (`!입장`, `!퇴장`)**: 보이스 채널 입장/퇴장 지원
* **🌐 웹서버 Keep-Alive**: 외부 호스팅 환경에서도 24시간 상시 가동 유지
